...
# --- REST API / Frontend connection ---
# During development Next.js runs on port 3000 and Django on port 8000.
# These settings allow the browser to send session cookies between them.
